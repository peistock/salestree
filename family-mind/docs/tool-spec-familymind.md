# FamilyMind 工具规范 v1.1（FamilyMind 适配版）
...
FamilyMind 不是"帮老人管理健康"的工具，而是**"帮老人重新成为家庭叙事中心"的协作者**。健康看护是底线，创作表达是主线，两者共用同一套记忆体和技能树。
...
*本文档作为 FamilyMind 双螺旋架构的工具体系契约。记忆做宽，技能做全，Agent 做灵。*
